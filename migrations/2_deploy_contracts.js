        ...
        .then(() => {
            return deployer.deploy(FlightSuretyApp, FlightSuretyData.address)
                .then(() => {
                    ...
                    fs.writeFileSync(__dirname + '/../web/src/dapp/config.json', JSON.stringify(config, null, '\t'), 'utf-8');
                    fs.writeFileSync(__dirname + '/../web/src/server/config.json', JSON.stringify(config, null, '\t'), 'utf-8');
                });
        });
}